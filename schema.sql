...
--
-- Name: bind_student_device(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.bind_student_device(p_student_id uuid, p_mac_raw text) OWNER TO postgres;

--
-- Name: check_hash(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.check_hash(raw text, hashed text) OWNER TO postgres;

--
-- Name: id_decrypt(bytea); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.id_decrypt(enc bytea) OWNER TO postgres;

--
-- Name: id_decrypt_with_key(bytea, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.id_decrypt_with_key(enc bytea, key text) OWNER TO postgres;

--
-- Name: id_encrypt(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.id_encrypt(raw text) OWNER TO postgres;

--
-- Name: id_encrypt_with_key(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.id_encrypt_with_key(raw text, key text) OWNER TO postgres;

--
-- Name: make_hash(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.make_hash(raw text) OWNER TO postgres;

--
-- Name: normalize_mac(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.normalize_mac(mac text) OWNER TO postgres;

--
-- Name: sha256_bytes(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.sha256_bytes(in_text text) OWNER TO postgres;

--
-- Name: tgt_update_timestamp(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.tgt_update_timestamp() OWNER TO postgres;

--
-- Name: unbind_by_device(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.unbind_by_device(p_mac_raw text) OWNER TO postgres;

--
-- Name: unbind_by_student(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.unbind_by_student(p_student_id uuid) OWNER TO postgres;
...
--
-- Name: jiuchongmemory; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.jiuchongmemory OWNER TO postgres;

--
-- Name: jiuchongmemory_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.jiuchongmemory_id_seq OWNER TO postgres;

--
-- Name: jiuchongmemory_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: langchain_pg_embedding_backup_20251203_group1; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.langchain_pg_embedding_backup_20251203_group1 OWNER TO postgres;

--
-- Name: langchain_pg_embedding_backup_group2; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.langchain_pg_embedding_backup_group2 OWNER TO postgres;

--
-- Name: memory_doc_backup_20231203_group1; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.memory_doc_backup_20231203_group1 OWNER TO postgres;

--
-- Name: memory_doc_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.memory_doc_id_seq OWNER TO postgres;

--
-- Name: memory_doc_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: memory_doc; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.memory_doc OWNER TO postgres;

--
-- Name: memory_doc_backup_group2; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.memory_doc_backup_group2 OWNER TO postgres;

--
-- Name: memory_vec; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.memory_vec (
    id integer NOT NULL,
...
ALTER TABLE public.memory_vec OWNER TO postgres;

--
-- Name: memory_vec_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.memory_vec_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.memory_vec_id_seq OWNER TO postgres;

--
-- Name: memory_vec_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.memory_vec_id_seq OWNED BY public.memory_vec.id;
...
--
-- Name: prompt_profile; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.prompt_profile OWNER TO postgres;

--
-- Name: COLUMN prompt_profile."group"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: prompt_profile_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.prompt_profile_id_seq OWNER TO postgres;

--
-- Name: prompt_profile_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: jiuchongmemory id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: memory_doc_backup_20231203_group1 id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: memory_vec id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.memory_vec ALTER COLUMN id SET DEFAULT nextval('public.memory_vec_id_seq'::regclass);


--
-- Name: prompt_profile id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: jiuchongmemory jiuchongmemory_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: langchain_pg_embedding_backup_20251203_group1 langchain_pg_embedding_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: langchain_pg_embedding_backup_group2 langchain_pg_embedding_pkey1; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: langchain_pg_embedding langchain_pg_embedding_pkey2; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: memory_doc_backup_20231203_group1 memory_doc_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: memory_doc_backup_group2 memory_doc_pkey1; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: memory_doc memory_doc_pkey2; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: memory_vec memory_vec_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.memory_vec
    ADD CONSTRAINT memory_vec_pkey PRIMARY KEY (id);


--
-- Name: prompt_profile prompt_profile_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: prompt_profile prompt_profile_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: prompt_profile prompt_profile_username_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_devices_current_student; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_devices_label; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_devices_pair_sha; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_prompt_profile_user; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_students_bound_mac; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_students_id_sha; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_students_idhash; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_students_last6; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_syslog_ip_time; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_syslog_mac_time; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_syslog_student; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ux_devices_current_student; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ux_students_bound_mac; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: prompt_profile trg_prompt_profile_ts; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: devices devices_current_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: langchain_pg_embedding_backup_20251203_group1 langchain_pg_embedding_collection_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: students students_bound_mac_normalized_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: system_logs system_logs_mac_normalized_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: system_logs system_logs_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
